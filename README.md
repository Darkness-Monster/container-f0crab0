...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-f0crab0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-f0crab0.containers.anotherwebservice.com/
...
```
git clone git@github.com:Darkness-Monster/container-f0crab0.git
cd container-f0crab0
```
...
```
docker attach container-f0crab0
```
